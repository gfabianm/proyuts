...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-04-2026 a las 03:33:10
...
INSERT INTO `cursos` (`id`, `nombre`, `descripcion`, `cupo_maximo`, `proyuts_otorgados`, `categoria_id`, `estado_id`, `fecha_creacion`, `profesor_id`) VALUES
(1, 'Programacion Web', 'Curso orientado al desarrollo de aplicaciones web', 30, 10, 3, 1, '2026-04-22 03:58:46', NULL),
(2, 'Aplicaciones Moviles', 'Curso enfocado en desarrollo móvil', 25, 12, 4, 1, '2026-04-22 03:58:46', NULL),
(3, 'POO', 'Curso de programación orientada a objetos', 35, 8, 5, 1, '2026-04-22 03:58:46', NULL),
(5, 'curos prueba', 'dasdas', 3, 2, 3, 1, '2026-04-22 04:17:00', NULL);
...
INSERT INTO `inscripciones` (`id`, `usuario_id`, `curso_id`, `fecha_inscripcion`, `estado_inscripcion`) VALUES
(9, 2, 1, '2026-04-28 04:36:09', 'INSCRITO');
...
INSERT INTO `usuarios` (`id`, `nombre`, `apellido`, `email`, `password`, `telefono`, `programa_academico`, `biografia`, `foto`, `activo`, `fecha_registro`) VALUES
(1, 'Fabian', 'Gelvez', 'admin@proyuts.com', '$2a$10$b3nQSilm3kTM8WZt/hVPVePx1Gen5UYugeqB0doKWVguyXcZWxKrK', '3000000000', 'Ingenieria de Software', 'Usuario de prueba', 'default.png', 1, '2026-04-22 03:00:00'),
(2, 'Jhonatan', 'Gelvez', 'Jhonatan@proyuts.edu.co', '$2a$10$LbO2BWC0ElfTeHCjPDhaoOYTF7.EX1Uq.C36XQai8Zzw5XPNIAkUm', '3124567890', 'Sistemas', 'Soy un nuevo estudiante', 'default.png', 1, '2026-04-28 02:52:12');
...
ALTER TABLE `cursos`
  ...
  ADD CONSTRAINT `fk_cursos_profesor` FOREIGN KEY (`profesor_id`) REFERENCES `usuarios` (`id`);
